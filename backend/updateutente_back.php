                ...
                <?php
                    if(isset($_POST['update'])){
                        ...
                        if(isset($_POST['utenteautorizzato'])){
                            ...
                            $query = 'UPDATE persona SET nome=\''.$_POST['nome'].'\', cognome=\''.$_POST['cognome'].'\', dipartimento=\''.$_POST['dipartimento'].'\', ruolo=\''.$_POST['ruolo'].'\', data_autorizzazione=NOW(), autorizzato_da=\''.$admin.'\' WHERE email =\''.$_POST['email'].'\';';
                        } else {
                            $query = 'UPDATE persona SET nome=\''.$_POST['nome'].'\', cognome=\''.$_POST['cognome'].'\', dipartimento=\''.$_POST['dipartimento'].'\', ruolo=\''.$_POST['ruolo'].'\', data_autorizzazione=NULL, autorizzato_da=NULL WHERE email =\''.$_POST['email'].'\';';
                        }
